...
// import { CrudError, ValidateToCreate, ValidateToUpdate } from './validation-2/validation'; 
...
// // Create -------------------------------------------------
// export async function Create( model:IModel, inputs:any[] ) { 
...
// // Read ---------------------------------------------------
// export async function Read( model:IModel, ids?:string[] ) {
